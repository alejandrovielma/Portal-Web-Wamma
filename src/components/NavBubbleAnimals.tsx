...
export function NavBubbleAnimals() {
  const bubbleItems = [
    {
      name: "Anfibios",
    ...
    },
    {
      ...
      image: "./public/images/Garzas.jpg",
    },
    {
      name: "Crustáceos",
      ...
      image: "./public/images/Crustaceos.jpg",
    },
    {
      name: "Reptiles",
      ...
      image: "./public/images/Reptiles.jpg",
    },
    {
      name: "Peces",
